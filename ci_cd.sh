...
python -c "from app import greet; assert greet(\"test\") == \"Welcome to LoopCart v1.0, test!\"; print(\"[CI] Tests passed\")"
echo "[CI] Step 2/3 - Building release artifact..."
echo "[CI] Step 2/3 - Building release artifact..."
python -c "import zipfile; f='release-v1.0.zip'; z=zipfile.ZipFile(f,'w'); z.write('app.py'); z.close()"
